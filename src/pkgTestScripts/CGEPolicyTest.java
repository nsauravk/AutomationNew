...
import pkgWebPages.CGEPolicy;

public class CGEPolicyTest {
	
	WebDriver driverMain;
	PolUW_LandingPage objDashboard = new PolUW_LandingPage();
	CGEPolicy objPolUW = new CGEPolicy();
	...
	@Test(enabled = true, priority = 0, testName="This testcase is used to test submitting new policy proposal for CGE")
	public void addNewPolicyProposal() throws Exception {
		...
		actualResult = objPolUW.addNewCGEPolicyProposal(driverMain);
