...
public class SECPolicyTest {
	...
	@Test(enabled = true, priority = 1, testName="This testcase is used to test submitting new policy proposal for SEC")
	public void addNewPolicyProposal() throws Exception {
		...
		actualResult = objPolUW.addNewSECPolicyProposal(driverMain);
