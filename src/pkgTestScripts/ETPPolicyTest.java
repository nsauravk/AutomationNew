...
import pkgWebPages.ETPPolicy;

public class ETPPolicyTest {
	
	WebDriver driverMain;
	PolUW_LandingPage objDashboard = new PolUW_LandingPage();
	ETPPolicy objPolUW = new ETPPolicy();
...
//		driverMain = BaseClass.getWebDriver();
	...
	@Test(enabled = true, priority = 1, testName="This testcase is used to test submitting new policy proposal for ETP")
	public void addNewPolicyProposal() throws Exception {
		...
		actualResult = objPolUW.addNewETPPolicyProposal(driverMain);
