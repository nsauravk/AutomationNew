...
import pkgWebPages.SITESPolicy;

public class SITESPolicyTest {
	
	WebDriver driverMain;
	PolUW_LandingPage objDashboard = new PolUW_LandingPage();
	SITESPolicy objPolUW = new SITESPolicy();
...
//		driverMain = BaseClass.getWebDriver();
	...
	@Test(enabled = true, priority = 1, testName="This testcase is used to test submitting new policy proposal for SITES")
	public void addNewPolicyProposal() throws Exception {
		...
		actualResult = objPolUW.addNewSITESPolicyProposal(driverMain);
