...
import pkgWebPages.GenerateOfficeNote;

public class GenerateOfficeNoteTest {

	WebDriver driverMain;
	static String expectedMsg, actualMsg;
	PolUW_LandingPage objDashboard = new PolUW_LandingPage();
	GenerateOfficeNote objGenerateOfficeNote = new GenerateOfficeNote();
	...
	public void addBWPPolicy() throws Exception {
		...
		actualMsg = objGenerateOfficeNote.addGenerateOfficeNote(driverMain);
	}
