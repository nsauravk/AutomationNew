...
public class MBEPolicy {
	
	PropertiesSetupFile objPSF = new PropertiesSetupFile("MBEPolicy");
	...
	public String addNewMBESmallPolicyProposal(WebDriver driver) {
		try {
			...
			objEBWT.selectProductMBELarge(driver, "MBE");
...
//			drpdwnList.selectByIndex(1);
			...
			Thread.sleep(5000);
			objEBWT.fillHeaderDetailsMBE(driver);
			...
			objEBWT.fillExportTurnoverInLast12CalendarMonths(driver);
			objEBWT.fillDebtorsDistribution(driver);
			objEBWT.fillAgeDebtorAnalysis(driver);
			objEBWT.fillOverdueDetailsAsOnDate(driver);
			objEBWT.fillprojectedTurnoverNext12Month(driver);
			objEBWT.fillDetailsOfProjectedExportTurnoverForTheNext12CalendarMonths(driver);
			objEBWT.fillUploadDocuments(driver);
			objEBWT.fillMBEPolicyDetails(driver);
	...
	public String addNewMBELargePolicyProposal(WebDriver driver) {
		try {
...
//			objEBWT.fillSMEPolicyDetails(driver);
//			objEBWT.fillCustomerDetailsMites(driver);
//			objEBWT.fillAnticipatedTurnoverForTheNextOneYearOnTheBuyer(driver);
//			objEBWT.fillOrdersOnHand(driver);
...
//			objEBWT.fillExportTurnoverInLast12CalendarMonths(driver);
//			objEBWT.fillOverdueDetailsAsOnDate(driver);
//			objEBWT.fillTurnoverNext12Month(driver);
//			objEBWT.fillprojectedExportTurnoverNext12CalendarMonth(driver);
//			objEBWT.fillDebtorsDistribution(driver);
//			objEBWT.fillAgeDebtorAnalysis(driver);
//			objEBWT.fillMerchantingTrade(driver);
//			objEBWT.fillSCRPolicyDetails(driver);
	...
	public String addNewMBEGJDPolicyProposal(WebDriver driver) {
		try {
			...
			objEBWT.searchInwardDetails(driver);
			objEBWT.searchExporterDetails(driver);
			objEBWT.selectProductMBEGJD(driver, "MBE");
