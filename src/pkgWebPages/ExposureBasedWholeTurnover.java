...
public class ExposureBasedWholeTurnover {

	DataSource objDataSource = new DataSource();
//	LinkedHashMap<String, String> inputMap = new LinkedHashMap<String, String>();
	LinkedHashMap<String, String> inputMap = new LinkedHashMap<String, String>();

	PropertiesSetupFile objPSF = new PropertiesSetupFile("ExposureBasedWholeTurnover");
...
//			poluwElement.sendKeys("10");
	...
	public void fillprojectedTurnoverNext12Month(WebDriver driver) {
		try {
			...
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys("1000000000");
...
//			System.out.println(Integer.parseInt(poluwElement.getText().replaceAll("[^0-9]", "")));
	...
	public void fillDetailsOfProjectedExportTurnoverForTheNext12CalendarMonths(WebDriver driver) {
		try {
			...
			poluwElement = driver
					.findElement(objPSF.getLocator("btn_DetailsOfProjectedExportTurnoverForTheNext12CalendarMonths"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
...
//			poluwElement.sendKeys("10000000");
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_MBE_Remark"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("Testing");
...
//			poluwElement.getText();
	...
	public void fillCustomerDetailsMites(WebDriver driver) {
		try {
			...
			drpdwnList = new Select(
					driver.findElement(objPSF.getLocator("drpdwn_CustomerDetails_CustomerCountry_Mites")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
...
//			util.getRandomValueFromDropdown(driver, drpdwnList);
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_ExperienceWithCustomer_HighestExposure_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
...
//		util.waitForElementToBeClickable(driver, poluwElement);
			...
			statusList = new Select(driver.findElement(objPSF.getLocator("drpdwn_antiturnovertopid_Mites")));
			util.selectRandomValueFromDropdown(driver, statusList);
	...
	public void fillNatureOfContractMites(WebDriver driver) {
		try {
			...
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drp_Nature_Assessment_Method_Mites")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
...
//			poluwElement.sendKeys("1000000");
			...
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("10,00,00,000");
...
//			poluwElement.getText();
	...
	public void fillHeaderDetailsMBE(WebDriver driver) {
		try {
			Thread.sleep(2000);
...
//			util.waitForVisibilityOfElement(driver, poluwElement);
			Thread.sleep(1000);
			poluwElement.sendKeys("2023000071");
