...
//			poluwElement.sendKeys("1234592W");
	...
	public void selectProductMBESmall(WebDriver driver, String policyType) {
		try {
			...
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_polSubType")));
			util.waitForDropdownOptions(driver, drpdwnList);
			drpdwnList.selectByIndex(3);
	...
	public void selectProductMBELarge(WebDriver driver, String policyType) {
		try {
	...
	public void selectProductMBEGJD(WebDriver driver, String policyType) {
		try {
...
//			System.out.println(Integer.parseInt(poluwElement.getText().replaceAll("[^0-9]", "")));
	...
	public void fillPartADetails(WebDriver driver) {
		try {
...
//			poluwElement.sendKeys("US");
	...
	public void fillCreditManagementRiskAppraisal(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_creditMgmtRiskAppraisal_BuyerExposureReviewBasis"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("CreditInformation"));

			poluwElement = driver.findElement(objPSF.getLocator("txt_creditMgmtRiskAppraisal_BuyerExposureReviewDetails"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("CreditInformation"));


			poluwElement = driver.findElement(objPSF.getLocator("txt_creditMgmtRiskAppraisal_NonPaymentPreventiveAction"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("NonPayment"));

			poluwElement = driver.findElement(objPSF.getLocator("txt_creditMgmtRiskAppraisal_NonPaymentRecoveryAction"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("NonPayment"));
...
//			poluwElement.sendKeys("ECGC");
			...
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_globalEntityStockHolder_Country")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
//			util.waitForDropdownOptions(driver, drpdwnList);
...
//			poluwElement.sendKeys(inputMap.get("NameOfTheInsurance"));
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_globalEntityStockHolderBankDetails_BankAccNo"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			...
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_globalEntityStockHolderBankDetails_Country")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
//			util.waitForDropdownOptions(driver, drpdwnList);
	...
	public void fillShipmentMadeToBuyerOrLCOpeningBankInLast1Year(WebDriver driver) {
		try {
			...
			Thread.sleep(2000);
			inputMap = objDataSource.readData("PolicyProposal");
			poluwElement = driver.findElement(objPSF.getLocator("btn_allShipmentsToBuyerOrLCOpeningBankInLast1YearTab"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			...
			poluwElement = driver.findElement(objPSF.getLocator("date_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_ShipmentDate"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			util.setCurrentDate(poluwElement);
			
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_Value"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_TopID")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
			

			poluwElement = driver.findElement(objPSF.getLocator("date_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_PaymentDueDate"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			util.setCurrentDate(poluwElement);

			poluwElement = driver.findElement(objPSF.getLocator("date_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_RealizationDueDate"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			util.setCurrentDate(poluwElement);

			poluwElement = driver.findElement(objPSF.getLocator("txt_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_DelayOrOverdueReason"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("NonPayment"));

			poluwElement = driver.findElement(objPSF.getLocator("btn_detailsOfAllShipmentsToBuyerOrLCOpeningBankInLast1Year_AddNewValue"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
	...
	public void fillQuarterwiseExpectedSales(WebDriver driver) {
		try {
			...
			poluwElement = driver
					.findElement(objPSF.getLocator("txt_quarterWiseExpectedSalesThroughAgent_IndianRupees_Quarter1"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			poluwElement = driver
					.findElement(objPSF.getLocator("txt_quarterWiseExpectedSalesThroughAgent_IndianRupees_Quarter2"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			poluwElement = driver
					.findElement(objPSF.getLocator("txt_quarterWiseExpectedSalesThroughAgent_IndianRupees_Quarter3"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			poluwElement = driver
					.findElement(objPSF.getLocator("txt_quarterWiseExpectedSalesThroughAgent_IndianRupees_Quarter4"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
			 ...
			 */
			poluwElement = driver
					.findElement(objPSF.getLocator("btn_quarterWiseExpectedSalesThroughAgent_ForeignCurrency_Save"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
...
//			poluwElement.click();
			...
			poluwElement = driver
					.findElement(objPSF.getLocator("txt_expectedAnnualTurnoverInEachCountry_ExpectedAnnualTurnover"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			poluwElement = driver.findElement(objPSF.getLocator("btn_expectedAnnualTurnoverInEachCountry_AddNewValue"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
	...
	public void fillExportTurnoverInLast12CalendarMonths(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_exportTurnoverLast12m_PercentExportBuyerToTotalExport"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("40");
	...
	public void fillprojectedTurnoverNext12Month(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_projectedTurnoverNxt12m_TotalProjectedSalesTurnover"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("ValueOfTheExport"));
//			poluwElement.sendKeys("500000000000");
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_projectedTurnoverNxt12m_TotalProjectedExportTurnover"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("ValueOfTheExport"));
...
//			poluwElement.sendKeys("1111");
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_projectedExportTurnoverNext12CalendarMonth_BuyerName"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("BuyerNameOfInsuranceDetails"));
...
//			util.selectRandomValueFromDropdown(driver, drpdwnList);
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_projectedExportTurnoverNext12CalendarMonth_PercentageOfExportToBuyer"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("30");

			poluwElement = driver.findElement(objPSF.getLocator("btn_projectedExportTurnoverNext12CalendarMonth_AddEntry"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
...
//			poluwElement.sendKeys("10");
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_0To25L_TotalAmountOutstandingOnLC"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_0To25L_TotalAmountOutstandingOnNonLC"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_0To25L_TotalAmountOutstandingOnOthers"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_25LTo50L_TotalAmountOutstandingOnLC"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Amount_Outstanding"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_25LTo50L_TotalAmountOutstandingOnNonLC"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Amount_Outstanding"));

			
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_25LTo50L_TotalAmountOutstandingOnOthers"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Amount_Outstanding"));
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_50LTo1M_TotalAmountOutstandingOnLC"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Amount_Outstanding"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_50LTo1M_TotalAmountOutstandingOnNonLC"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Amount_Outstanding"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_debtorsDistribution_50LTo1M_TotalAmountOutstandingOnOthers"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Amount_Outstanding"));
	...
	public void fillAgeDebtorAnalysis(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_agewiseDebtorAnalysis_OutstandingAmountAgeing_0To90"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
	...
	// Header details policy proposal form
...
//			poluwElement.sendKeys("SBI Bank");
	...
	// Details of all shipments made to the buyer/ LC opening bank in the last one year
...
//			poluwElement.sendKeys("No Reason");
	...
	// Orders on Hand tab for policy proposal form
	public boolean fillDetailsOfOrderContractLCOnHand(WebDriver driver) throws Exception {
		try {

			JavascriptExecutor j = (JavascriptExecutor) driver;
			j.executeScript("window.scrollBy(0,-500)");

			poluwElement = driver.findElement(objPSF.getLocator("link_lconhand"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("txt_onhandordernum"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("1234");

			statusList = new Select(driver.findElement(objPSF.getLocator("drpdwn_onhandtopid")));
			util.waitForVisibilityOfElement(driver, poluwElement);
			statusList.selectByVisibleText("LTCLOC-5220");

			poluwElement = driver.findElement(objPSF.getLocator("txt_onhandforeigncurr"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys("10000");

			poluwElement = driver.findElement(objPSF.getLocator("txt_onhandamountinr"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys("100000000");

			poluwElement = driver.findElement(objPSF.getLocator("btn_submitonhand"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
...
//Other Proposal Details for SBE product.
	public boolean fillSBEPolicyDetails(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_sbe_buyerassociateddet"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("BuyerNameOfInsuranceDetails"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_sbe_descofcommodity"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("NonPayment"));
...
//			util.waitForDropdownOptions(driver, drpdwnList);
	...
	public void fillCustomerDetails(WebDriver driver) {
		try {
			...
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_CustomerDetails_CustomerCountry")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
...
//			util.waitForVisibilityOfElement(driver, poluwElement);
	...
	public void fillCustomerDetailsMites(WebDriver driver) {
		try {
			
			Thread.sleep(2000);
			inputMap = objDataSource.readData("PolicyProposal");
			poluwElement = driver.findElement(objPSF.getLocator("link_customerDetails_Mites"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_Name_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("BuyerNameOfInsuranceDetails"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_AddressLine_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			util.enterAddressLine1(poluwElement);
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_CustomerStreet_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			util.enterAddressLine2(poluwElement);
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_CustomerCity_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Bank_Branch_Address"));
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_CustomerState_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("StateInfo"));
			
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_CustomerDetails_CustomerCountry_Mites")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_CustomerPhoneNo_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("02347112233");	
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_CustomerEmail_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			util.enterRandomMailID(poluwElement);
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_CustomerFaxNo_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("+12-345-1234567");
...
//			poluwElement.sendKeys("90");
			...
			poluwElement = driver.findElement(objPSF.getLocator("radiobtn_CustomerDetails_Government_Mites"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_CustomerDetails_Government"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.clear();
			poluwElement.sendKeys(inputMap.get("NonPayment"));
			
			poluwElement = driver.findElement(objPSF.getLocator("btn_CustomerDetails_Save_Mites"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
	...
	try {
		...
		Thread.sleep(2000);
		inputMap = objDataSource.readData("PolicyProposal");
		poluwElement = driver.findElement(objPSF.getLocator("link_natureOfContract"));
		util.waitForElementToBeClickable(driver, poluwElement);
		poluwElement.click();

		poluwElement = driver.findElement(objPSF.getLocator("txt_Nature_Assessment_Method1"));
		util.waitForVisibilityOfElement(driver, poluwElement);
		poluwElement.sendKeys(inputMap.get("NonPayment"));
		
		poluwElement = driver.findElement(objPSF.getLocator("txt_Nature_SystemOfBilling"));
		util.waitForVisibilityOfElement(driver, poluwElement);
		poluwElement.sendKeys(inputMap.get("NonPayment"));
		
		poluwElement = driver.findElement(objPSF.getLocator("txt_Nature_SystemOfSendingBill"));
		util.waitForVisibilityOfElement(driver, poluwElement);
		poluwElement.sendKeys(inputMap.get("NonPayment"));
		
		poluwElement = driver.findElement(objPSF.getLocator("txt_Nature_PaymentStructure"));
		util.waitForVisibilityOfElement(driver, poluwElement);
		poluwElement.sendKeys(inputMap.get("NonPayment"));
	...
	// Nature of Contract tab for MITES policy proposal
	public void fillNatureOfContractMites(WebDriver driver) {
	try {
		Thread.sleep(2000);
		inputMap = objDataSource.readData("PolicyProposal");
		poluwElement = driver.findElement(objPSF.getLocator("link_natureOfContract_Mites"));
		util.waitForElementToBeClickable(driver, poluwElement);

		poluwElement.click();
		
		poluwElement = driver.findElement(objPSF.getLocator("txt_Nature_Assessment_Method_Mites"));
		util.waitForVisibilityOfElement(driver, poluwElement);
		poluwElement.sendKeys(inputMap.get("NonPayment"));
...
//			poluwElement.getText();
	...
	public boolean fillMITESPolicyDetails(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("link_Other_Proposal_Details_MITES"));
			util.waitForElementToBeClickable(driver, poluwElement);
//			Thread.sleep(2000);
			poluwElement.click();
			
			poluwElement = driver.findElement(objPSF.getLocator("radiobtn_MITES_Customer_Risks"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.click();
			
//			poluwElement = driver.findElement(objPSF.getLocator("txt_Loss_Limit_Turnover_MITES"));
//			util.waitForVisibilityOfElement(driver, poluwElement);
//			poluwElement.clear();
//			poluwElement.sendKeys("1000000");
			
			poluwElement = driver.findElement(objPSF.getLocator("txt_Requested_Loss_Limit_MITES"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));
			
			poluwElement = driver.findElement(objPSF.getLocator("btn_MITES_Save_Other1"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			...
			m1.executeScript("window.scrollBy(0,-800)");

			poluwElement = driver.findElement(objPSF.getLocator("btn_MITES_Submit_other1"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
...
//			poluwElement.getText();
	...
	public void fillSMEPolicyDetails(WebDriver driver) {
		try {

			JavascriptExecutor m = (JavascriptExecutor) driver;
			m.executeScript("window.scrollBy(0,-500)");

			poluwElement = driver.findElement(objPSF.getLocator("link_Other_Proposal_Details_SME"));
//			util.waitForElementToBeClickable(driver, poluwElement);
			Thread.sleep(2000);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("radiobtn_SME_No_Cover_Required"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("btn_MITES_Save_Other"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

			Thread.sleep(2000);

			poluwElement = driver.findElement(objPSF.getLocator("btn_MITES_Submit_other"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
	...
	public void fillMBEPolicyDetails(WebDriver driver) {
		try {


			System.out.println("Click the other proposal tab");

			JavascriptExecutor m = (JavascriptExecutor) driver;
			m.executeScript("window.scrollBy(0,-500)");

			poluwElement = driver.findElement(objPSF.getLocator("link_Other_Proposal_Details_MBE"));
			util.waitForElementToBeClickable(driver, poluwElement);
//			poluwElement.click();
			poluwElement.click();

			JavascriptExecutor m1 = (JavascriptExecutor) driver;
			m1.executeScript("window.scrollBy(0,-300)");

			poluwElement = driver.findElement(objPSF.getLocator("radiobtn_MBE_PoliticalRiskOnly"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("radiobtn_MBE_No_Cover_Required"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("txt_MBE_AnyOtherRequirement"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("No Requirement");

//			poluwElement = driver.findElement(objPSF.getLocator("txt_MBE_AnyticipatedMaximumOutstandingAmt"));
//			util.waitForVisibilityOfElement(driver, poluwElement);
//			poluwElement.clear();
//			poluwElement.sendKeys("10000000");

			poluwElement = driver.findElement(objPSF.getLocator("btn_MBE_Save_Other"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

			Thread.sleep(2000);
			poluwElement = driver.findElement(objPSF.getLocator("btn_MBE_Submit_other"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			Thread.sleep(1000);
			driver.switchTo().alert().accept();
...
//			poluwElement.getText();
	...
	// Fill Details Of Projected Export Turnover For The Next 12 Calendar Months Tab
	public void fillDetailsOfProjectedExportTurnoverForTheNext12CalendarMonths(WebDriver driver) {
		try {
			
			JavascriptExecutor d = (JavascriptExecutor) driver;
			d.executeScript("window.scrollBy(0,-500)");

			poluwElement = driver.findElement(objPSF.getLocator("btn_DetailsOfProjectedExportTurnoverForTheNext12CalendarMonths"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

			JavascriptExecutor d1 = (JavascriptExecutor) driver;
			d1.executeScript("window.scrollBy(0,-500)");

			Thread.sleep(2000);

			statusList = new Select(
					driver.findElement(objPSF.getLocator("drpdwn_DetailsOfProjectedExport_BuyerCountry")));
			util.selectRandomValueFromDropdown(driver, statusList);

			statusList = new Select(
					driver.findElement(objPSF.getLocator("drpdwn_DetailsOfProjectedExport_TermsOfPayment")));
			util.waitForDropdownOptions(driver, statusList);
			statusList.selectByVisibleText("DP-120");

			poluwElement = driver.findElement(objPSF.getLocator("txt_DetailsOfProjectedExport_ShipmentValue"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("1000000");

			poluwElement = driver.findElement(objPSF.getLocator("btn_DetailsOfProjectedExport_AddNew"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
			Thread.sleep(2000);
...
//			Thread.sleep(1000);
	...
	public void fillUltimateBuyerLossDetails(WebDriver driver) {
		try {
			...
			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_ultimateBuyerLossDetails_Country")));
			util.getRandomValueFromDropdown(driver, drpdwnList);
...
//			poluwElement.getText();
	...
	public void fillExperienceWithCustomer(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("btn_ExperienceWithCustomer"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
	...
	public void fillExperienceWithCustomerMites(WebDriver driver) {
		try {

			Thread.sleep(2000);
			inputMap = objDataSource.readData("PolicyProposal");

			poluwElement = driver.findElement(objPSF.getLocator("btn_ExperienceWithCustomer_Mites"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

//			drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_ExperienceWithCustomer_Month_Mites")));
//			util.getRandomValueFromDropdown(driver, drpdwnList);

			poluwElement = driver.findElement(objPSF.getLocator("txt_ExperienceWithCustomer_CustomerName_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("BuyerNameOfInsuranceDetails"));

			poluwElement = driver.findElement(objPSF.getLocator("txt_ExperienceWithCustomer_ValueOfInvoices_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			drpdwnList = new Select(
					driver.findElement(objPSF.getLocator("drpdwn_ExperienceWithCustomer_TermOfPayment_Mites")));
			util.getRandomValueFromDropdown(driver, drpdwnList);

			poluwElement = driver
					.findElement(objPSF.getLocator("txt_ExperienceWithCustomer_HighestExposure_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Sales_Turnover"));

			poluwElement = driver.findElement(objPSF.getLocator("txt_ExperienceWithCustomer_ReasonForDelay_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("NonPayment"));

			poluwElement = driver.findElement(objPSF.getLocator("btn_ExperienceWithCustomer_AddNew_Mites"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
	...
	public void fillAnticipatedTurnoverForTheNextOneYearOnTheBuyerMites(WebDriver driver) {
		try {

			Thread.sleep(2000);
			inputMap = objDataSource.readData("PolicyProposal");

			poluwElement = driver.findElement(objPSF.getLocator("link_antiturnover_Mites"));
//		util.waitForElementToBeClickable(driver, poluwElement);
			Thread.sleep(1000);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("txt_antiturnover_CustomerName_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("BuyerNameOfInsuranceDetails"));
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_antiturnovervalue_TotalValue_Mites"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys(inputMap.get("Total_Value_Bad_Debts"));


			poluwElement = driver.findElement(objPSF.getLocator("btn_antiturnovervalue_AddNew_Mites"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
	...
	public void SMEOtherProposalDetails(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("btn_SME_Tab"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("btn_SME_Tab"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			if (poluwElement.getText().contains("Other Proposal Details (SME)"))
				System.out.println("Active: SME Proposal Details tab");
			else
				System.out.println("Not Active: SME Proposal Details tab");

			poluwElement = driver.findElement(objPSF.getLocator("radiobtn_SME_CoverRequired"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.click();

			poluwElement = driver.findElement(objPSF.getLocator("btn_SME_save"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();

			Thread.sleep(3000);

			poluwElement = driver.findElement(objPSF.getLocator("btn_SME_submit"));
			util.waitForElementToBeClickable(driver, poluwElement);
			poluwElement.click();
			driver.switchTo().alert().accept();
...
//			poluwElement.getText();
	...
	public void searchPolicyDetailsEndorsement(WebDriver driver) {
		try {
			Thread.sleep(2000);
			poluwElement = driver.findElement(objPSF.getLocator("link_Search_Policy_Details"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.click();

			statusList = new Select(driver.findElement(objPSF.getLocator("drpdwn_policyTypeEndorsement")));
			util.selectRandomValueFromDropdown(driver, statusList);
