...
public class SCRPolicy {
	
	PropertiesSetupFile objPSF = new PropertiesSetupFile("SCRPolicy");
	...
	public String addNewSCRPolicyProposal(WebDriver driver) {
		try {
...
//			objDBWT.selectProduct(driver,"SCR");
...
//			drpdwnList.selectByValue("Comprehensive cover (commercial plus political risk)");
...
//			drpdwnList.selectByIndex(1);
			...
			objDBWT.fillprojectedTurnoverNext12Month(driver);
			...
			objDBWT.fillSCRPolicyDetails(driver);
