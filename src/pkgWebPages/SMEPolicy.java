...
public class SMEPolicy {
	...
	PropertiesSetupFile objPSF = new PropertiesSetupFile("SMEPolicy");
	...
	public String addNewSMEPolicyProposal(WebDriver driver) {
		try {
			...
			objEBWT.selectProduct(driver, "SME");
...
//			drpdwnList.selectByIndex(1);
			...
			objEBWT.SMEOtherProposalDetails(driver);
