...
public class SRCPolicy {
	...
	PropertiesSetupFile objPSF = new PropertiesSetupFile("SRCPolicy");
	...
	public String addNewSRCPolicyProposal(WebDriver driver) {
		try {
			...
			objDBWT.selectProduct(driver, "SRC");
...
//			objDBWT.fillUploadDocuments(driver);
			...
			objDBWT.fillSubmitSRCPolicyDetails(driver);
