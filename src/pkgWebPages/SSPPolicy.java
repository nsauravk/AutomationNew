...
public class SSPPolicy {
	
	String actualMsg, getWholeMsg;
	boolean status = false;
	WebElement poluwElement;
	PropertiesSetupFile objPSF = new PropertiesSetupFile("SSPPolicy");
	...
	public String addPolUW_SSPPolicy(WebDriver driver) throws Exception {
		try {
			...
			objDBI.selectProduct(driver, "SSP");
...
//			System.out.println(getWholeMsg);
			...
			objDBI.fillOrdersOnHandSSP(driver);
...
//			objDBI.fillSBEPolicyDetails(driver);
//			objDBI.fillSSPPolicyDetails(driver);
