...
public class SITESPolicy {
	
	PropertiesSetupFile objPSF = new PropertiesSetupFile("SITESPolicy");
	...
	public String addNewSITESPolicyProposal(WebDriver driver) {
		try {
			...
			objEBI.selectProduct(driver, "SITES");
...
//			objEBI.fillSITESPolicyDetails(driver);
