...
public class ETPPolicy {
	
	PropertiesSetupFile objPSF = new PropertiesSetupFile("ETPPolicy");
	...
	public String addNewETPPolicyProposal(WebDriver driver) {
		try {
...
//			objDBWT.fillUploadDocuments(driver);
			objDBWT.fillETPPolicyDetails(driver);
