...
public class DeclarationBasedIndividual {

	DataSource objDataSource = new DataSource();
//	LinkedHashMap<String, String> inputMap = new LinkedHashMap<String, String>();
	LinkedHashMap<String, String> inputMap = new LinkedHashMap<String, String>();

	PropertiesSetupFile objPSF = new PropertiesSetupFile("DeclarationBasedIndividual");
...
//			util.waitForElementToBeClickable(driver, poluwElement);
//			poluwElement.clear();
			poluwElement.sendKeys("20/08/2023");
...
//			Thread.sleep(1000);
			 ...
			 * util.waitForVisibilityOfElement(driver, poluwElement); poluwElement.clear();
			 ...
			 * 
			 * // poluwElement =
			 * driver.findElement(objPSF.getLocator("txt_detbuyercontperson")); //
			 * util.waitForVisibilityOfElement(driver, poluwElement); //
			 * poluwElement.clear(); // poluwElement.sendKeys("Roman");
			 * 
			 * poluwElement =
			 * driver.findElement(objPSF.getLocator("txt_detbuyercontperson"));
			 * util.waitForVisibilityOfElement(driver, poluwElement);
			 ...
			 * util.enterRandomID(poluwElement);
			 * 
			 * // BWP Policy Proposal form eight FORM B /* poluwElement =
			 * driver.findElement(objPSF.getLocator("txt_altbuyeraddress"));
			 * util.waitForVisibilityOfElement(driver, poluwElement);
...
//				poluwElement.sendKeys("No Reason");
	...
	public boolean fillOrdersOnHand(WebDriver driver) {
		try {
			...
			poluwElement = driver.findElement(objPSF.getLocator("txt_OrderOnHand_Exchange_Rate"));
			util.waitForVisibilityOfElement(driver, poluwElement);
			poluwElement.sendKeys("50");
...
//				util.waitForDropdownOptions(driver, drpdwnList);
		...
		public void fillQuarterwiseExpectedSales(WebDriver driver) {
			try {
				...
				/*
				 * poluwElement = driver.findElement( objPSF.getLocator(
				 * "txt_quarterWiseExpectedSalesThroughAgent_ForeignCurrency_Quarter1"));
				 * util.waitForVisibilityOfElement(driver, poluwElement); poluwElement.clear();
				 * poluwElement.sendKeys(inputMap.get("Total_Export_Turnover"));
				 * 
				 * poluwElement = driver.findElement( objPSF.getLocator(
				 * "txt_quarterWiseExpectedSalesThroughAgent_ForeignCurrency_Quarter2"));
				 * util.waitForVisibilityOfElement(driver, poluwElement); poluwElement.clear();
				 * poluwElement.sendKeys(inputMap.get("Total_Export_Turnover"));
				 * 
				 * poluwElement = driver.findElement( objPSF.getLocator(
				 * "txt_quarterWiseExpectedSalesThroughAgent_ForeignCurrency_Quarter3"));
				 * util.waitForVisibilityOfElement(driver, poluwElement); poluwElement.clear();
				 * poluwElement.sendKeys(inputMap.get("Total_Export_Turnover"));
				 * 
				 * poluwElement = driver.findElement( objPSF.getLocator(
				 * "txt_quarterWiseExpectedSalesThroughAgent_ForeignCurrency_Quarter4"));
				 * util.waitForVisibilityOfElement(driver, poluwElement); poluwElement.clear();
				 * poluwElement.sendKeys(inputMap.get("Total_Export_Turnover"));
				 * 
				 * 
		...
		public void fillExpectedAnnualTurnoverEachCountry(WebDriver driver) {
			try {
				...
				poluwElement = driver
						.findElement(objPSF.getLocator("radiobtn_expectedAnnualTurnoverInEachCountry_Yes"));
				util.waitForElementToBeClickable(driver, poluwElement);
				poluwElement.click();
...
//				poluwElement.getText();
		...
		public void fillOrdersOnHandSSP(WebDriver driver) {
			try {
				...
				poluwElement = driver.findElement(objPSF.getLocator("link_OrderOnHand_SSP"));
				util.waitForElementToBeClickable(driver, poluwElement);
				poluwElement.click();

				drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_OrderOnHand_Type_SSP")));
				util.getRandomValueFromDropdown(driver, drpdwnList);

				poluwElement = driver.findElement(objPSF.getLocator("txt_OrderOnHand_OrderNo_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				util.enterRandomID(poluwElement);

				statusList = new Select(driver.findElement(objPSF.getLocator("drpdwn_OrderOnHand_Payment_SSP")));
				util.getRandomValueFromDropdown(driver, statusList);

				poluwElement = driver.findElement(objPSF.getLocator("txt_OrderOnHand_Amount_Foreign_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				poluwElement.sendKeys(inputMap.get("Profit_Loss_After_Tax"));

				drpdwnList = new Select(driver.findElement(objPSF.getLocator("drpdwn_Foreign_Currency_SSP")));
				util.getRandomValueFromDropdown(driver, drpdwnList);

				poluwElement = driver.findElement(objPSF.getLocator("txt_OrderOnHand_Exchange_Rate_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				poluwElement.sendKeys("50");

//				poluwElement = driver.findElement(objPSF.getLocator("txt_OrderOnHand_Amount_INR_SSP"));
//				util.waitForVisibilityOfElement(driver, poluwElement);
//				poluwElement.sendKeys(inputMap.get("Profit_Loss_After_Tax"));

				poluwElement = driver.findElement(objPSF.getLocator("date_Contract_LC_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				util.setCurrentDate(poluwElement);

				poluwElement = driver.findElement(objPSF.getLocator("date_Contract_LC_Expiry_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				util.setCurrentDate(poluwElement);

				poluwElement = driver.findElement(objPSF.getLocator("date_Last_Date_Within_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				util.setCurrentDate(poluwElement);

				poluwElement = driver.findElement(objPSF.getLocator("txt_Cover_Required_Amount_In_Foreign_SSP"));
				util.waitForVisibilityOfElement(driver, poluwElement);
				poluwElement.sendKeys(inputMap.get("Profit_Loss_After_Tax"));
